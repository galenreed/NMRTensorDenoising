...
%
%   Read spectral data from a file specified in
%   the string 'FileName' into the arrays x (abscissa)
%   and y (ordinate).
%   The structure Pars contains entries from the
%   parameter file, if present.
%
%  All strings in the parameter structure
%   containing numbers are converted to numbers for easier use.
%
...
%   the parameter file. See the fields XPTX, XMIN, XWID
...
%     SpecMan:         .d01, .exp
%
%   If no extension is given, .DTA and .DSC are assumed
%
%   ****************************************************
