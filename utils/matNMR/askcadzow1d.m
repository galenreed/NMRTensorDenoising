...
%
%
%askcadzow1d.m handles input for Cadzow filtering
%
%03-03-'08
...
try
  if (QmatNMR.FIDstatus == 1) 		%frequency-domain data
    ...
    QuiInput('Cadzow filtering :', ' OK | CANCEL', 'regelcadzow1d', [], ...
    		'Window size of Hankel matrix (0.2-0.5) :', QmatNMR.CadzowWindow, ...
    		'nr of frequencies in specified windows :', QTEMP, ...
                  'Repeat how many times :', QmatNMR.CadzowRepeat);
  
  else 					%time-domain data
    QuiInput('Cadzow filtering :', ' OK | CANCEL', 'regelcadzow1d', [], ...
  		'Window size of Hankel matrix (0.2-0.5) :', QmatNMR.CadzowWindow, ...
  		'nr of frequencies :', QmatNMR.CadzowNrFreqs, ...
                  'Repeat how many times :', QmatNMR.CadzowRepeat);
  end
