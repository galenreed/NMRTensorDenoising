...
%
%
%regelgrid.m sets the XGrid, YGrid and ZGrid properties for the current axis
%31-03-'99
...
try
  if QmatNMR.buttonList == 1			%OK-button
    ...
    if (QmatNMR.RecordingPlottingMacro)
      ...
      QmatNMR.Macro = AddToMacro(QmatNMR.Macro, 731, QTEMP12.SubPlots, QmatNMR.uiInput1, QmatNMR.uiInput1a, QmatNMR.uiInput2, QmatNMR.uiInput2a, QmatNMR.uiInput3, QmatNMR.uiInput3a, QmatNMR.uiInput4);
    end
    ...
    if (QmatNMR.uiInput4 == 1)			%Only change selected axes
      ...
      for QTEMP4 = 1:length(QmatNMR.AllAxes)
        ...
        if ~isempty(QmatNMR.AxesNR)
          if QmatNMR.uiInput1a
            set(QmatNMR.AllAxes(QTEMP4), 'xgrid', QTEMP1);
          end
          if QmatNMR.uiInput2a
            set(QmatNMR.AllAxes(QTEMP4), 'ygrid', QTEMP2);
          end
          if QmatNMR.uiInput3a
            set(QmatNMR.AllAxes(QTEMP4), 'zgrid', QTEMP3);
          end
        end	  
      end
      ...
      disp('Grid changed for selected axes ...');
    ...
    elseif (QmatNMR.uiInput4 == 2) 		%apply to all subplots
      ...
      disp('Grid changed for all axes ...');
    ...
    elseif (QmatNMR.uiInput4 == 3) 		%apply to the current row of subplots
      ...
      disp('Grid changed for all axes in the current row ...');
    ...
    elseif (QmatNMR.uiInput4 == 4) 		%apply to the current column of subplots
      ...
      disp('Grid changed for all axes in the current column ...');
    end  
  
  else
    disp('Setting of XGrid, YGrid and ZGrid properties was cancelled ...');
  end  
