...
%
%
%Markersize.m sets the Markersize in the current axis to a certain value ...
%
%11-06-'98

function ret = Markersize(Var);
  ...
  if (QmatNMR.RecordingPlottingMacro)
    ...
    QmatNMR.Macro = AddToMacro(QmatNMR.Macro, 736, QTEMP12.SubPlots, Var, get(QTEMP20, 'userdata'));
  end
  ...
  set(findobj(QTEMP, 'type', 'line'), 'Markersize', Var);
  set(findobj(QTEMP, 'type', 'patch'), 'Markersize', Var);
  set(findobj(QTEMP, 'type', 'Surface'), 'Markersize', Var);
