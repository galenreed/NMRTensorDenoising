...
%
%
%asksimpsonasciilaadSeries.m opens an input window to get information about the series
%of SIMPSON ASCII files that needs to be read into MATLAB
%07-11-'01


try
  if (QmatNMR.Xfilename == 0)		%first check whether a previous filename exists
    simpsonasciilaadSeries			%if not, go to the normal "binary FID" mode
    ...
    QuiInput('Read SIMPSON ASCII file from disk :', 'OK | CANCEL', 'regelsimpsonasciilaadSeries', [], ...
