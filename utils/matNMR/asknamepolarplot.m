...
%
%
%asknamepolarplot.m handles the input for the polar plotting routine.
%
%30-07-'01
%
...
try
  ...
  drawnow
  QuiInput('Polar plot :', ' OK | CANCEL', 'regelpolarplot', [], ...
           'Name Spectrum :', QmatNMR.SpecName2D3D, ...
           '&POAxis ?|No Axis|Only Lines|Lines and Labels', QmatNMR.PolarPlotAxis, ...
           '&POPlot type ?| pcolor | contourf (rel.) | contourf (abs.) | contour (rel.) | contour (abs.)', QmatNMR.PolarPlotPlotType, ...
           'Vector with Contour levels', QmatNMR.PolarPlotContourLevels, ...
           ...
           '&POType of contours|Only Positive|Only Negative|Abs. Pos. and Abs. Neg.|Positive and Negative rel. to Positive Maximum', QmatNMR.negcont, ...
