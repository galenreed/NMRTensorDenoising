...
%
%
% regelinputbuttonssimpsonasciilaadSeries4
%
    ...
    if (~isempty(QTEMP2) & (length(QTEMP2) == 2))
      ...
      elseif (QTEMP2 > QTEMP3(end)) 	%last file separator found before '$range$ code
        ...
        if (strcmp(QTEMP4, QTEMP1(QTEMP2(1):QTEMP2(2))) & (find(QTEMP3 == QTEMP2(1)) > 1))
          QTEMP4 = [QTEMP1( QTEMP3(find(QTEMP3 == QTEMP2(1)) - 2)+1:QTEMP3(find(QTEMP3 == QTEMP2(1)) - 1)-1) '_' QTEMP4];
        end
      end
      ...
      %
      set(findobj(QmatNMR.uiInputFig, 'tag', '2'), 'string', QTEMP4);
    end
