...
%
%
%askstoppeakfit.m asks the user whether the peak fitting routine must be stopped. Is not invoked if the
...
try
  if QmatNMR.matNMRSafety
    ...
    drawnow
    QuiInput('Quit peak fitting routine ?', 'YES | NO', 'stoppeakfit', []);
