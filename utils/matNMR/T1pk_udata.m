...
%
%
function [ed,ck, fitbut, TolBut, NrIterBut, redisbut, lijstbut, simplexbut, stopbut, printbut, refreshbut, logbut, txt1, txt2, txt5, txt6, txt7, txt8, txt9, txt10, txt11, logbut2] = T1pk_udata();
...
QTEMP = get(findobj(0, 'Tag', 'T1fit'),'userdata');
...
TolBut = handle_list(23);		%These buttons are used in T1fit and are therefore extracted
...
txt8 = handle_list(37);
txt9 = handle_list(38);
txt10= handle_list(39);
txt11= handle_list(40);

logbut2 = handle_list(41);
