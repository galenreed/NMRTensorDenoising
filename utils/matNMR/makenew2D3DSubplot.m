...
%
%
%makenew2D3DSubplot creates a new subplot configuration in the current 2D/3D viewer window
%
%07-12-2004
...
try
  ...
  %
  QTEMP1 = get(QmatNMR.Fig2D3D, 'colormap');
  ...
  %
  set(QmatNMR.Fig2D3D, 'colormap', QTEMP1);
