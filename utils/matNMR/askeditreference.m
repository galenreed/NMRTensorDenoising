...
%
%
%askeditreference allows editing an external reference that was loaded from external datasets 
%into matNMR and subsequently stored in the workspace.
%
%29-09-2004
...
try
  ...
  QuiInput('Apply external reference from workspace :', 'OK | CANCEL', 'regeleditreference', [], ...
           'Variable : ', QmatNMR.ExternalReferenceVar);
