...
%
%
%asksavedisk1d.m asks for a name for the 1D spectrum to be saved on disk

try
  QuiInput('Save 1D spectrum on disk :', ' OK | CANCEL', 'regelsavedisk1d', [], ... 
           ...
           '&CKSave current axis in structure ?', QmatNMR.SaveAxis, ...
