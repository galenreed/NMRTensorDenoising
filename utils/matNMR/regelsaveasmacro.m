...
%
%
%regelsaveasmacro.m handles the saving of the current History to a variable in the
%workspace.
%
%16-04-'01
...
try
  if (QmatNMR.buttonList == 1)
    ...
    eval(['global ' QmatNMR.uiInput1]);		%make sure the macro is a global
    eval([QmatNMR.uiInput1 ' = QmatNMR.HistoryMacro;']);
    disp(['Current processing history save as variable "' QmatNMR.uiInput1 '"']);
  
    Arrowhead
  else
  
    disp('Saving of the history to a variable cancelled ...');
  end
