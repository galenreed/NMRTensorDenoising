...
%
%
%asknamepcolor3d.m handles the input for the polar plotting routine.
%
%30-07-'01
%
...
try
  ...
  drawnow
  QuiInput('Bar 3D plot :', ' OK | CANCEL', 'regelpcolor3d', [], ...
  		'Name Spectrum :', QmatNMR.SpecName2D3D, ...
           	...
           	'Elevation (vertical) in degrees : ', QmatNMR.el, ...
                  '&POType of object | Bar | Cylinder', QmatNMR.Bar3DType, ...
