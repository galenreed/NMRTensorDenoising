...
%
%
%Linestyle.m sets the linestyle in the current axis to a certain value ...
%
%11-06-'98

function ret = Linestyle(Var);
  ...
  if (QmatNMR.RecordingPlottingMacro)
    ...
    QmatNMR.Macro = AddToMacro(QmatNMR.Macro, 733, QTEMP12.SubPlots, get(QTEMP20, 'userdata'));
  end
  ...
  set(findobj(QTEMP, 'type', 'line'), 'linestyle', Var);
  set(findobj(QTEMP, 'type', 'patch'), 'linestyle', Var);
  set(findobj(QTEMP, 'type', 'surface'), 'linestyle', Var);
