...
% matNMRCadzow1DTD
%
% syntax: [MatrixOut, SV] = matNMRCadzow1DTD(MatrixIn, WindowSize, NrFreqs, CadzowRepeat)
%
...
function [MatrixOut, SV] = matNMRCadzow1DTD(MatrixIn, WindowSize, NrFreqs, CadzowRepeat)
