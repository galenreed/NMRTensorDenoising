...
%
%
%askstopssafit.m asks the user whether the SSA fitting routine must be stopped. Is not invoked if the
...
try
  if QmatNMR.matNMRSafety
    ...
    drawnow
    QuiInput('Quit SSA fitting routine ?', 'YES | NO', 'stopssafit', []);
