...
%
%
%regelbar.m takes care of the input for the plotting of 1D bar plots
%18-04-2001
...
try
  if QmatNMR.buttonList == 1
    ...
    QmatNMR.Q1DBarWidth  = eval(QmatNMR.uiInput3);
    QmatNMR.Q1DBarColour = QmatNMR.uiInput4;
