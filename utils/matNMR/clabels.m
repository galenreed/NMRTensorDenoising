...
try
  ...
  elseif(QmatNMR.command2 == 6)		%refresh
    ...
    QTEMP1 = get(get(get(QmatNMR.Fig2D3D, 'currentaxes'),'XLabel'),'string');
    if (size(QTEMP1, 1) > 1)
      QTEMP3 = deblank(QTEMP1(1, :));
      for QTEMP2=2:size(QTEMP1, 1)
        QTEMP3 = [QTEMP3 '\n' deblank(QTEMP1(QTEMP2, :))];
    ...
    QTEMP1 = get(get(get(QmatNMR.Fig2D3D, 'currentaxes'),'YLabel'),'string');
    if (size(QTEMP1, 1) > 1)
      QTEMP3 = deblank(QTEMP1(1, :));
      for QTEMP2=2:size(QTEMP1, 1)
        QTEMP3 = [QTEMP3 '\n' deblank(QTEMP1(QTEMP2, :))];
    ...
    QTEMP1 = get(get(get(QmatNMR.Fig2D3D, 'currentaxes'),'ZLabel'),'string');
    if (size(QTEMP1, 1) > 1)
      QTEMP3 = deblank(QTEMP1(1, :));
      for QTEMP2=2:size(QTEMP1, 1)
        QTEMP3 = [QTEMP3 '\n' deblank(QTEMP1(QTEMP2, :))];
    ...
    QTEMP1 = get(get(get(QmatNMR.Fig2D3D, 'currentaxes'),'Title'),'string');
    if (size(QTEMP1, 1) > 1)
      QTEMP3 = deblank(QTEMP1(1, :));
      for QTEMP2=2:size(QTEMP1, 1)
        QTEMP3 = [QTEMP3 '\n' deblank(QTEMP1(QTEMP2, :))];
