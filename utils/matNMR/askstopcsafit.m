...
%
%
%askstopcsafit.m asks the user whether the CSA-tensor fitting routine must be stopped. Is not invoked if the
...
try
  if QmatNMR.matNMRSafety
    ...
    drawnow
    QuiInput('Quit CSA-tensor fitting routine ?', 'YES | NO', 'stopcsafit', []);
