...
%
%
%regelgetslice.m takes a row from the current 2D spectrum and plots it as a 1D spectrum.
%24-12-'96
...
try
  if QmatNMR.buttonList == 1						%= OK-button
    ...
    if (strcmp(QmatNMR.uiInput1, 'end'))
      QmatNMR.uiInput1 = num2str(QmatNMR.SizeTD1, 10);
    end
      
    if ((eval(QmatNMR.uiInput1) > 0) & (eval(QmatNMR.uiInput1) <= QmatNMR.SizeTD1))
      QmatNMR.rijnr = eval(QmatNMR.uiInput1);
      ...
      disp('ERROR: number of requested row is out of bounds !!!');
    end
