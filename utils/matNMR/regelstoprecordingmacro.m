...
%
%
%regelstoprecordingmacro.m stops the recording of macros and allows to save the macro in the
%workspace.
%24-03-'99
...
try
  ...
  if (QmatNMR.RecordingMacro == 1)	%for processing macros with processing actions
  ...
  if (QmatNMR.buttonList == 1)
    eval([QmatNMR.uiInput1 ' = QmatNMR.Macro;']);
    
    disp(['Recording macro stopped. Macro was saved in the workspace as "' QmatNMR.uiInput1 '"']);
  else
    disp('Recording macro stopped. Macro was NOT saved in the workspace');
  end
