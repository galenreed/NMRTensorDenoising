...
%
%
%askCMXlaad.m opens an input window to get information about the CMX processed data
...
try
  if (QmatNMR.Xfilename == 0)		%first check whether a previous filename exists
    CMXlaad				%if not, go to the normal "binary FID" mode
    ...
    QuiInput('Read Chemagnetics spectra files from disk :', 'OK | CANCEL', 'regelCMXSpectraread', [], ...
             ...
             '&CKRead standard parameter files? &CAregelinputbuttonsCMXlaad', QmatNMR.ReadParameterFilesFlag, ...
